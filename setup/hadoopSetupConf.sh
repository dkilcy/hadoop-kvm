...
backupConf $DIR/$FILE
preConf $DIR/$FILE
appendConf $DIR/$FILE "fs.default.name" "hdfs://centos-server-1:9000" "URI of NameNode"
postConf $DIR/$FILE
...
backupConf $DIR/$FILE
preConf $DIR/$FILE
appendConf 	$DIR/$FILE "mapred.job.tracker" "centos-server-1:9001" "Host or IP and port of JobTracker"
...
appendConf 	$DIR/$FILE "mapred.tasktracker.map.tasks.maximum" "3" ""
appendConf 	$DIR/$FILE "mapred.tasktracker.reduce.tasks.maximum" "3" ""
appendConf 	$DIR/$FILE "mapred.child.java.opts" "-Xmx512m" ""
postConf $DIR/$FILE
